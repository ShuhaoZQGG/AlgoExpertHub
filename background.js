...
(async () => {
  ...
  // const client_secret = await chrome.storage.local.get('client_secret');

  // chrome.runtime.onMessage.addListener(async function(request, sender, sendResponse) {
  //   console.log(request);
  //   if (request.name === "AuthorizeUrlMessage" && request.AuthorizeUrl) {
  ...
  //         await chrome.runtime.sendMessage({name: "AuthorizeState", authorized: "true"});
  //       } catch (err) {
  //         console.error(err);
  //       }
  //     }
